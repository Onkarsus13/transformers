...
"""Image processor class for ConFiDeNet."""
...
if TYPE_CHECKING:
    from .modeling_confidenet import ConFiDeNetDepthEstimatorOutput
...
class ConFiDeNetImageProcessor(BaseImageProcessor):
    r"""
    Constructs a ConFiDeNet image processor.
    ...
    def resize(
        ...
        **kwargs,
        ...
        # we use torch interpolation instead of image.resize because ConFiDeNetImageProcessor
    ...
    def post_process_depth_estimation(
        self,
        outputs: "ConFiDeNetDepthEstimatorOutput",
            ...
            results.append(
                {
                    ...
                    "predicted_depth_uint16": depth_uint16,
...
__all__ = ["ConFiDeNetImageProcessor"]
